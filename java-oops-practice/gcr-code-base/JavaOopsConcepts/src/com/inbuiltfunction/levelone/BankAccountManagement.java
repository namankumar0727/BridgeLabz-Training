...
public class BankAccountManagement {
	   ...
	   public BankAccountManagement(String accountHolderName, String accountNumber, double balance) {
	   ...
	   public void displayAccountDetails() {
	       ...
	       if (this instanceof BankAccountManagement) {
	   ...
	   public static void main(String[] args) {
	       ...
	       BankAccountManagement account1 = new BankAccountManagement("Lynda Princy", "ACC12345", 1000.00);
	       BankAccountManagement account2 = new BankAccountManagement("Prince Danish", "ACC67890", 500.00);
	       ...
	       BankAccountManagement.getTotalAccounts();
